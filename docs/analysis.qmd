...
- created a nested tibble split with the responses crossed with the
  covariates
...
- construct model formula of the form
  ...
  $\beta_0$ represents the global intercept, $\beta$ is the population
  effect parameters (associated with the focal covariate, $X$).
  $\upsilon_{reef}$ and $\upsilon_{depth}$ represent the varying
  effects of reef and depth within reef respectively.
